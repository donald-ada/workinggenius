...
Not a deletion tool. A line removed without its retirement note leaves a hole that reads exactly like a stage that never ran, and in this flow absence is a record with a meaning of its own. Nothing is removed silently, including something you wrote yourself an hour ago.
