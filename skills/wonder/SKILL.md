...
1. Read the snapshot (`genius-file` skill); walk unfamiliar territory first (`blindspot` skill). Everything the repo, the history or the docs can settle is homework done now, never a question asked later.
...
4. Write the problem statement back to them — success observable, scope edged — and ask for the yes. Their words, not a nod at something vague enough to nod at.
