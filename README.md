...
- [ASD-STE100 Simplified Technical English](https://asd-ste100.org/) — the form the work file borrows: short sentences, one fact each, one term per concept, written for a reader who wasn't there. Its ban on explaining *why* is deliberately not borrowed — why is what the next session needs most
